...
esri.Map.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"basemap-change","click","dbl-click","extent-change","key-down","key-up","layer-add","layer-add-result","layer-remove","layer-reorder","layer-resume","layer-suspend","layers-add-result","layers-removed","layers-reordered","load","mouse-down","mouse-drag","mouse-drag-end","mouse-drag-start","mouse-move","mouse-out","mouse-over","mouse-up","mouse-wheel","pan","pan-end","pan-start","reposition","resize","time-extent-change","unload","update-end","update-start","zoom","zoom-end","zoom-start"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
    panDown: function () {
...
esri.dijit.BasemapGallery = function (params,srcNodeRef) {
    ...
    /// <field name="portalUrl" type="String">Optional parameter to pass in a portal URL, including the instance name, used to access the group containing the basemap gallery items. E.g. www.myportal.com/myInstance or http://www.myportal.com/myInstance. If the page runs under https the portal URL is automatically converted to https://www.myportal.com/myInstance. See the portal documentation for more info on the portal instance name.</field>
};
...
esri.dijit.BasemapLayer = function (params) {
    ...
    /// <field name="type" type="String">The type of layer. Must specify either the url or type parameter except for WebTiledLayers where url and type is required.</field>
};
...
esri.dijit.HistogramTimeSlider.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"time-extent-change","update"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
};
...
esri.dijit.HomeButton = function (params,srcNodeRef) {
    ...
    /// &#60;Boolean&#62; visible</param>
    /// <param name="srcNodeRef" type="DOMNode | String" optional="false">Reference or id of a HTML element that this dijit is rendered into.</param>
    /// <field name="extent" type="Extent">The extent used to zoom to when clicked. If null, it will use starting extent.</field>
    /// <field name="loaded" type="Boolean">Whether the widget has been loaded.</field>
    /// <field name="map" type="Map">Map object that this dijit is associated with.</field>
    /// <field name="theme" type="String">Class used for styling the widget.</field>
    /// <field name="visible" type="Boolean">Whether the widget is visible by default.</field>
...
esri.dijit.LocateButton = function (params,srcNodeRef) {
    ...
    /// &#60;Boolean&#62; visible</param>
    /// <param name="srcNodeRef" type="DOMNode | String" optional="false">Reference or id of a HTML element that this dijit is rendered into.</param>
    /// <field name="geolocationOptions" type="Object">The HTML5 Geolocation Position options for locating. Refer to Geolocation API Specification for details.</field>
...
esri.dijit.Popup.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"clear-features","hide","maximize","restore","selection-change","set-features","show"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
    reposition: function () {
...
esri.dijit.PopupMobile.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"clear-features","hide","selection-change","set-features","show"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
    select: function (index) {
        /// <summary>Selects the feature at the specified index.</summary>
...
esri.dijit.analysis.AggregatePoints = function (params,srcNodeRef) {
    ...
    /// <field name="groupByField" type="String">A field name from pointLayer based on which the points will be grouped. This will be shown selected in the Choose field to group by (optional) menu by default. If not specified, users can still select a field.</field>
    ...
    /// <field name="outputLayerName" type="String">The name of the output layer to be shown in the Result layer name inputbox. If not specified, "Aggregation of ${point_layer_title} to ${polygon_layer_title}" will be shown by default.</field>
    ...
    /// <field name="polygonLayer" type="FeatureLayer">The polygon layer to be shown selected in in the Choose area menu. Must be one of the layers specified in polygonLayers.</field>
    /// <field name="polygonLayers" type="FeatureLayer[]">An array of feature layer candidates to be selected as the input polygon layer. When a layer is selected by user, the AggregatePoints dijit will summarize points based on polygons on this polygon layer. These layer candidate will be shown in the Choose area menu.</field>
    /// <field name="portalUrl" type="String">The url to the ArcGIS.com site or in-house portal where the GP server is hosted.</field>
    /// <field name="returnFeatureCollection" type="Boolean">When true, returns the result of analysis as feature collection and creates a feature service. This value determines whether or not the result will be saved and published on a user's arcgis.com account.</field>
    ...
    /// <field name="showSelectFolder" type="Boolean">When true, the select folder dropdown will be shown. This parameter should be used when you want to allow users to select a folder in their arcgis.com account where the output feature layer will be exported as a service.</field>
    /// <field name="summaryFields" type="String[]">An array of attribute field names and statistic types that you would like to aggregate for all points within each polygon. The field names and statistic types your specify will be listed in the Add statistic (optional) menu. Note that even if you do not specify any, the default dropdown list will still allow users to select field names and statistic types.Syntax: ["fieldName summaryType","fieldName summaryType", ...]fieldName is the name of one of the numeric fields found in the input point layer.summaryType is one of the following:Sum - Adds the total value of all the points in each polygon.Mean - Calculates the average of all the points in each polygon.Min - Finds the smallest value of all the points in each polygon.Max - Finds the largest value of all the points in each polygon.Stddev - Finds the standard deviation of all the points in each polygon.Note that the count of points within each polygon is always returned.</field>
};
...
esri.dijit.analysis.AnalysisBase.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"close","drawtool-activate","drawtool-deactivate","job-cancel","job-fail","job-result","job-status","job-submit","job-success","start"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
};
...
esri.dijit.analysis.CreateBuffers = function (params,srcNodeRef) {
    ...
    /// <param name="srcNodeRef" type="DOMNode | String" optional="false">Reference or id of a HTML element that this dijit is rendered into.</param>
    /// <field name="analysisGpServer" type="String">URL to the GPServer to be used for this analysis.</field>
    /// <field name="bufferDistance" type="String">An array of buffer distances to buffer the input feature layer. These values will be shown in the "Enter buffer size" input textbox in the UX as default values. Multiple values must be separated by spaces within the string.</field>
    /// <field name="inputLayer" type="FeatureLayer">The input point, line, or polygon feature layer to be buffered.</field>
    /// <field name="map" type="Map">Reference to the map object.</field>
    /// <field name="outputLayerName" type="String">The name of the output layer to be shown in the Result layer name inputbox. If not specified, "Buffer of ${input_layer_title}" will be shown by default.</field>
    /// <field name="portalUrl" type="String">The url to the ArcGIS.com site or in-house portal where the GP server is hosted.</field>
    /// <field name="returnFeatureCollection" type="Boolean">When true, returns the result of analysis as feature collection and creates a feature service. This value determines whether or not the result will be saved and published on a user's arcgis.com account.</field>
    /// <field name="showChooseExtent" type="Boolean">When true, the choose extent checkbox will be shown.</field>
...
esri.dijit.analysis.FindHotSpots = function (params,srcNodeRef) {
    ...
    /// &#60;Boolean&#62; showSelectFolder</param>
    /// <param name="srcNodeRef" type="DOMNode | String" optional="false">Reference or id of a HTML element that this dijit is rendered into.</param>
    /// <field name="aggregationPolygonLayers" type="FeatureLayer[]">An array of feature layer candidates to be selected as the aggregation polygon layer. The aggregation polygon layer defines the boundaries within which incidents will be aggregated before analysis. When this layer is specified, the number of incidents within each polygon will be counted. These polygons with their incident counts will be used as the input features for analysis. The geometry of output hot spots layer will also be based on these polygons.For example, if you are analyzing traffic accidents in a city and the outlines of census tracts in that city are selected as bounding polygons, the output hot spots value will be based on each census tract instead of each accident's location.This parameter should be used only when analysisLayer is a point layer. It will be shown as an option under Choose an analysis field. This option is available only when analysisField is not selected.</field>
    /// <field name="analysisField" type="String">The numeric field in the AnalysisLayer that will be analyzed. When the AnalysisLayer is a point FeatureLayer, rather than a field name the AnalysisField may be "NO ANALYSIS FIELD".</field>
    /// <field name="analysisGpServer" type="String">URL to the GPServer to be used for this analysis.</field>
    /// <field name="analysisLayer" type="FeatureLayer">The feature layer for which hot spots will be calculated. Can be a polygon or a point layer.</field>
    /// <field name="boundingPolygonLayers" type="FeatureLayer[]">An array of feature layer candidates to be selected as the bounding polygon layer. The bounding polygon layer defines the study area within which incidents could have occurred. When this layer is specified, all locations within this layer will be analyzed, whether any incident occurred at a location or not. When not specified, only locations with at least one point (incident) will be included in the analysis.For example, if you are analyzing boating accidents in a harbor, the outline of the harbor might provide a good boundary for where accidents could occur. When no bounding areas are provided, only locations with at least one point will be included in the analysis.This parameter should be used only when the analysisLayer is a point layer. It will be shown as an option under Choose an analysis field. This option is available only when analysisField is not selected.</field>
    /// <field name="map" type="Map">Reference to the map object.</field>
    /// <field name="outputLayerName" type="String">The name of the output layer to be shown in the Result layer name inputbox. If not specified, "Hot Spots ${analysis_layer_title}" will be shown by default.</field>
    /// <field name="portalUrl" type="String">The url to the ArcGIS.com site or in-house portal where the GP server is hosted.</field>
    /// <field name="returnFeatureCollection" type="Boolean">When true, returns the result of analysis as feature collection and creates a feature service. This value determines whether or not the result will be saved and published on a user's arcgis.com account.</field>
    /// <field name="showChooseExtent" type="Boolean">When true, the choose extent checkbox will be shown.</field>
    /// <field name="showCredits" type="Boolean">When true, the show credit option is visible.</field>
...
esri.dijit.geoenrichment.Infographic = function (params,srcNodeRef) {
    ...
    /// <field name="subtitle" type="String">An HTML template string used to define the Infographic subtitle. The default value is: &#60;div&#62; ${address}&#60;/div&#62;&#60;div&#62;${name}&#60;/div&#62;If the study area is a point the address information is populated by performing a reverse geocode of the input study area. For other geometry types the value will be an empty string. The name information is a string representation of the studyAreaOptions used by the infographic. For example "1-mile ring". </field>
...
esri.dijit.geoenrichment.Infographic.prototype = 
{
    ...
    setData: function (data,metadata) {
        /// <summary>Define the infographic data. By default the Infographic uses online Geoenrichment services to obtain data. This method allows you to override this behavior to provide data from your own source. For example, you can use a FeatureSet returned from the GeoenrichmentTask.enrich method. </summary>
...
esri.dijit.geoenrichment.InfographicsOptions.Item = function (type,variables) {
    ...
    /// <param name="variables" type="String[]" optional="false">The set of variables displayed in this InfographicsOptions.Item.To return all variables in a category, specify this value as ["&#60;category_name&#62;.*"].The availability of variables varies from country to country. You may use this application to find variables available in your study area, or refer to the Data collections section in the ArcGIS GeoEnrichment Service documentation to find available variables.</param>
    /// <field name="datasetID" type="String">The ID of the dataset to which variables used in this Infographic belong.</field>
...
esri.geometry.Polygon.prototype = 
{
    ...
    getCentroid: function () {
        /// <summary>Returns the centroid of the polygon as defined here. For a polygon with multiple rings, returns the centroid of the largest ring. Note: Polygon with holes not supported at version 3.7.</summary>
        /// <return type="Point">Point</return>
    },
    getExtent: function () {
...
esri.layers.ArcGISDynamicMapServiceLayer = function (url,options) {
    ...
    /// <field name="maxImageWidth" type="Number">The maximum image width, in pixels, that the map service will export. Requires ArcGIS Server version 10.1 or greater.</field>
...
esri.layers.ArcGISDynamicMapServiceLayer.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"gdbversion-change","map-image-export","resume","scale-range-change","scale-visibility-change","suspend"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
    resume: function () {
...
esri.layers.ArcGISImageServiceLayer.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"map-image-export","mosaic-rule-change","rendering-change"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
...
esri.layers.ArcGISTiledMapServiceLayer.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"resume","scale-range-change","scale-visibility-change","suspend"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
    resume: function () {
        /// <summary>Resumes layer drawing.</summary>
...
esri.layers.FeatureLayer.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"add-attachment-complete","before-apply-edits","capabilities-change","dbl-click","delete-attachments-complete","edits-complete","query-attachment-infos-complete","query-count-complete","query-features-complete","query-ids-complete","query-limit-exceeded","query-related-features-complete","resume","scale-range-change","scale-visibility-change","selection-clear","selection-complete","suspend","update-end","update-start"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
...
esri.layers.GraphicsLayer = function () {
    ...
    /// <field name="dataAttributes" type="String | String[]">List of attribute fields added as custom data attributes to graphics node. Applicable only when layer surfaceType is "svg".</field>
    ...
    /// <field name="styling" type="Boolean">Indicates whether the layer is responsible for styling graphics. When true, styling is based on graphics symbol or the layer's renderer. When false, graphics styling is disabled. Applicable only when layer surfaceType is "svg".</field>
...
esri.layers.GraphicsLayer.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"click","dbl-click","graphic-add","graphic-draw","graphic-node-add","graphic-node-remove","graphic-remove","graphics-clear","mouse-down","mouse-drag","mouse-move","mouse-out","mouse-over","mouse-up"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
    redraw: function () {
...
esri.layers.KMLLayer.prototype = 
{
    ...
    on: function (event,true_or_false) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"refresh"</param>
        /// <param name="true_or_false" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
...
esri.layers.LabelLayer = function () {
    /// <summary>Creates a new Label layer. The constructor has no parameters.</summary>
};

esri.layers.LabelLayer.prototype = 
{
    addFeatureLayer: function (featureLayer,renderer,textExpression,labelOptions) {
        /// <summary>Adds reference to the feature layer which is labeled. You may add as many feature layers as you need.</summary>
        /// <param name="featureLayer" type="FeatureLayer" optional="false">The feature layer to be added to the label layer. Use FeatureLayer.MODE_ONDEMAND to improve the performance. Be sure the field(s) you would like to display is included in outFields.</param>
        /// <param name="renderer" type="SimpleRenderer | UniqueValueRenderer | ClassBreaksRenderer" optional="false">The renderer used to render text labels. For most applications SimpleRederer is best choice, but you can use UniqueValueRenderer or ClassBreaksRenderer.</param>
        /// <param name="textExpression" type="Object" optional="false">An expression determining what text and field(s) will be displayed as in labels.</param>
        /// <param name="labelOptions" type="Object" optional="true">An object providing additional options for changing label visibility and placement. The following options are available:  Option Available Values Default Value Applicable Feature Type   pointPriorities AboveLeft | CenterLeft | BelowLeft | BelowCenter | BelowRight | CenterRight | AboveRight | CenterCenter AboveRight Point   lineLabelPlacement PlaceAtStart | PlaceAtCenter | PlaceAtEnd PlaceAtCenter Line   lineLabelPosition Above | OnLine | Below Above Line   labelRotation true | false true Line   howManyLabels OneLabel | ManyLabels OneLabel Polygon </param>
    },
...
esri.layers.Layer = function (options) {
    ...
    /// <field name="refreshInterval" type="Number">Refresh interval of the layer in minutes. Non-zero value indicates automatic layer refresh at the specified interval. Value of 0 indicates auto refresh is not enabled.</field>
    /// <field name="showAttribution" type="Boolean">When true the layer's attribution is displayed on the map. The default value is true.</field>
...
{
    attr: function (name,value) {
        /// <summary>Adds a new attribute or changes the value of an existing attribute on the layer's node. Removes the attribute if the value is null or undefined.</summary>
        /// <param name="name" type="String" optional="false">The name of the attribute.</param>
        /// <param name="value" type="The attribute's value type" optional="false">The value of the attribute. Set this value as null to remove the attribute.</param>
        /// <return type="Layer">Layer</return>
    },
    ...
    getMap: function () {
        /// <summary>Returns reference to the map control the layer is added to. Returns null or undefined if it is not added to a map.</summary>
        /// <return type="Map">Map</return>
    },
    getNode: function () {
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"error","load","opacity-change","refresh-interval-change","resume","scale-range-change","scale-visibility-change","suspend","update","update-end","update-start","visibility-change"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
    resume: function () {
        /// <summary>Resumes layer drawing.</summary>
    ...
    setRefreshInterval: function (interval) {
        /// <summary>Changes the layer's refresh interval to the given value (in minutes). Non-zero value sets up automatic layer refresh at the specified interval. Value of 0 stops auto refresh.</summary>
...
esri.layers.StreamLayer.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"connect","disconnect","message","remove","update"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
};
...
esri.layers.WebTiledLayer = function (urlTemplate,options) {
    ...
    /// <field name="tileInfo" type="TileInfo">Define the tile info for the layer including lods, rows, cols, origin and spatial reference. If not set it will assume tiles in the Web Mercator tiling scheme.</field>
...
esri.renderer.ClassBreaksRenderer.prototype = 
{
    ...
    getBreakIndex: function (graphic) {
        /// <summary>Returns the index at which rendering and legend information can be found in the break infos array for the given graphic. Returns -1 if the renderer was unable to classify the graphic.</summary>
    ...
    setMaxInclusive: function (enable) {
        /// <summary>By default, a graphic or feature is considered a match for a class break if the graphic's attribute value is greater than or equal to its min value and less than its max value.</summary>
...
esri.renderer.DotDensityRenderer = function (parameters) {
    ...
    /// <field name="backgroundColor" type="dojo.Color">The color to be used for the background of the symbol. By default no background color will be applied.</field>
    ...
    /// <field name="fields" type="Object[]">An array of objects, where each object defines a field to be mapped and its color. Required.[ { name: &#60;String&#62;,  color : &#60;Color&#62; }, ...]Name represents the name of the field to be mapped.Color represents the color of the dot.</field>
    /// <field name="outline" type="LineSymbol">The line symbol to use on the outline of the feature. By default no outline will be applied.</field>
};

esri.renderer.DotDensityRenderer.prototype = 
{
    setBackgroundColor: function (color) {
        /// <summary>Updates the background color of the shape. For the changes to take effect, you need to call GraphicsLayer.redraw after calling this method.</summary>
        /// <param name="color" type="dojo.Color" optional="false">Background color.</param>
    },
    setDotSize: function (size) {
        /// <summary>Updates the size of the dot. Size represents screen pixels. For the changes to take effect, you need to call GraphicsLayer.redraw after calling this method.</summary>
        /// <param name="size" type="Number" optional="false">The size of the dot in pixels.</param>
    },
    setDotValue: function (value) {
        /// <summary>Updates the value that a dot represents. For the changes to take effect, you need to call GraphicsLayer.redraw after calling this method.</summary>
        /// <param name="value" type="Number" optional="false">The value that a dot represents.</param>
    },
    setOutline: function (outline) {
        /// <summary>Updates the outline symbol of the shape. For the changes to take effect, you need to call GraphicsLayer.redraw after calling this method.</summary>
...
esri.renderer.Renderer = function () {
    ...
    /// <field name="rotationInfo" type="Object">Defines how marker symbols are rotated. Use rotation to depict wind direction, vehicle heading etc. Specify an object with the following properties. </field>
};
...
esri.renderer.Renderer.prototype = 
{
    ...
    setProportionalSymbolInfo: function (info) {
        /// <summary>Modify rotation info for the renderer. The info object has the same properties as rotationInfo. For changes to take effect call the GraphicsLayer redraw method after calling this method. </summary>
    ...
    setRotationInfo: function (info) {
        /// <summary>Modifies rotation info for the renderer. The info argument has the same properties as rotationInfo.For the changes to take effect, you need to call GraphicsLayer.redraw after calling this method. </summary>
...
esri.renderer.ScaleDependentRenderer.prototype = 
{
    addRendererInfo: function (info) {
        /// <summary>Adds the specified renderer info to the array of existing renderers. In order to view the change call the GraphicsLayer redraw method. </summary>
    ...
    getRendererInfo: function (graphic) {
        /// <summary>Returns the renderer info for the input graphic. Note that the graphic should be part of a GraphicsLayer (or one of its sub-classes) that is added to the map. </summary>
    ...
    setRendererInfos: function (infos) {
        /// <summary>Replaces existing rendererInfos with new ones. The infos argument is an array of objects as described in the rendererInfos property. For the changes to take effect, call GraphicsLayer redraw after calling this method.</summary>
...
esri.symbol.SimpleMarkerSymbol = function () {
    ...
    /// <field name="size" type="Number">Size of the marker in pixels. The default value is 16 pixels. For marker symbols defined using SVG paths use "auto" to render the SVG path at its original size. </field>
...
esri.tasks.FindParameters = function () {
    ...
    /// <field name="layerIds" type="Number[]">The layers to perform the find operation on. The layers are specified as a comma-separated list of layer ids. The list of ids is returned in ArcGISDynamicMapServiceLayer layerInfos.</field>
...
esri.tasks.GenerateRendererParameters = function () {
    ...
    /// <field name="precision" type="Number">Round values for the renderer. It should only work with classBreaksRenderer</field>
...
esri.tasks.GeometryService.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"areas-and-lengths-complete","auto-complete-complete","buffer-complete","convex-hull-complete","cut-complete","difference-complete","distance-complete","error","generalize-complete","intersect-complete","label-points-complete ","label-points-complete","lengths-complete","offset-complete","project-complete","relation-complete","reshape-complete","simplify-complete","trim-extend-complete","union-complete"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
...
esri.tasks.Geoprocessor.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"error","execute-complete","get-result-data-complete","get-result-image-complete","get-result-image-layer-complete","job-cancel","job-complete","status-update"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
...
esri.tasks.IdentifyParameters = function () {
    ...
    /// <field name="layerDefinitions" type="String[]">Array of layer definition expressions that allows you to filter the features of individual layers. Layer definitions with semicolons or colons are supported at version 2.0 if using a map service published using ArcGIS Server 10.</field>
    /// <field name="layerIds" type="Number[]">The layers to perform the identify operation on. The layers are specified as a comma-separated list of layer ids. The list of ids is returned in ArcGISDynamicMapServiceLayer layerInfos.</field>
...
esri.tasks.Locator.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"address-to-locations-complete","addresses-to-locations-complete","error","location-to-address-complete"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
    setOutSpatialReference: function (spatialReference) {
        /// <summary>Sets the well-known ID of the spatial reference of the output geometries.</summary>
...
esri.tasks.QueryTask.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"complete","error","execute-for-count-complete","execute-for-ids-complete","execute-relationship-query-complete"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
};
...
esri.virtualearth.VEGeocoder.prototype = 
{
    ...
    on: function (event,callback) {
        /// <summary>Trigger a callback function when an event happens.</summary>
        /// <param name="event" type="String" optional="false">One of the following event names:&#10;"address-to-locations-complete","error"</param>
        /// <param name="callback" type="Function" optional="false">A callback function with a returned object as the first variable.</param>
    },
